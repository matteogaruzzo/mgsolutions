...
export const SOFTWARE_PLANS = {
  essenziale: {
    ...
    trialDays: 30,
    moduleLimit: 'all',
    moduleLimitLabel: 'Tutti i moduli operativi, scegli quali attivare',
    userLimit: 3,
    ...
    controlTower: false,
    features: [
      'Tutti i moduli operativi, scegli quali attivare',
      'Fino a 3 utenti',
      '1 sede',
      '2 integrazioni',
      'Supporto via email',
  ...
  ecosistema: {
    ...
    trialDays: 60,
    moduleLimit: 'all',
    moduleLimitLabel: 'Tutti i moduli, incluso Control Tower',
    userLimit: null,
    ...
    controlTower: true,
    features: [
      'Tutti i moduli, incluso Control Tower',
      'Utenti illimitati',
      'Fino a 5 sedi',
      '12 integrazioni',
      'MG Control Tower',
