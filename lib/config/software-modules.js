...
export const SOFTWARE_MODULES = [
  {
    ...
    cardSummary:
      'Centralizza contatti e opportunità in un’unica pipeline, con follow-up automatici. Niente più richieste perse tra email, agende e WhatsApp.',
    narrative: [
  ...
  },
  {
    ...
    cardSummary:
      'L’AI propone testi e grafiche coerenti con il tuo brand, tu approvi prima che escano. Presenza social costante senza assumere nessuno.',
    narrative: [
  ...
  },
  {
    ...
    cardSummary:
      'Prenotazioni online sempre aperte, con conferme e promemoria automatici. Ogni visita diventa un’occasione di vendita, non solo un appuntamento.',
    narrative: [
  ...
  },
  {
    ...
    cardSummary:
      'Turni, checklist e comunicazioni interne in un solo posto. Il team sa cosa fare senza riunioni continue.',
    narrative: [
  ...
  },
  {
    ...
    cardSummary:
      'Una dashboard che aggrega i dati degli altri moduli attivi — vendite, prenotazioni, social, personale — con un report AI settimanale che li interpreta.',
    narrative: [
