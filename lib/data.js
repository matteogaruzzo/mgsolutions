...
export const servizi = [
  ...
  },
  {
    ...
    whatIsItMore: [
      ...
      'Personalizziamo il tema in Shopify Liquid, con il supporto di Claude Code per uno sviluppo rapido e su misura quando il tema standard non basta, e colleghiamo corrieri, gestionali di magazzino e marketplace di settore via API, senza duplicare inserimenti manuali tra sistemi diversi.',
    ],
    quickFacts: [
  ...
  },
  {
    ...
    whatIsItMore: [
      ...
      'I modelli AI (OpenAI, Anthropic o Gemini, a seconda del caso) entrano nel flusso solo dove servono davvero — un quiz, una raccomandazione, un filtro anti-abbandono — e i dati restano centralizzati in un unico database, non sparsi tra automazioni scollegate tra loro.',
    ],
    quickFacts: [
...
export const businessSuiteModules = [
  ...
  },
  {
    ...
    narrative: [
      'Con un team stagionale che cresce e si riduce secondo la vendemmia o l’alta stagione, capire chi lavora quando, chi è disponibile per una sostituzione e se le checklist di apertura sono state rispettate diventa complicato molto in fretta — soprattutto se tutto passa da messaggi WhatsApp e fogli di carta.',
