...
// ---- PIANI PREZZO SOFTWARE (Stripe-ready, checkout non ancora collegato) --
export const pricingTiers = [
  {
    id: 'starter',
    name: 'Starter',
    price: 99,
    softwareIncluded: ['Agente Commerciale AI'],
    setup: '1h di consulenza',
    support: 'Email',
    trialDays: 30,
    highlight: null,
  },
  {
    ...
    price: 249,
    discountLabel: '-20%',
    softwareIncluded: ['Agente Commerciale AI', 'Assistente Clienti', 'Automazione Preventivi'],
    setup: '4h di consulenza + training',
  ...
  },
  {
    ...
    price: 349,
    discountLabel: '-30%',
    softwareIncluded: ['Tutti e 4 i software'],
    setup: '8h di consulenza + audit + training',
    support: 'Dedicato (Slack 24/5 + telefono)',
    customIntegrations: 'Fino a 2 integrazioni custom',
    trialDays: 60,
    highlight: 'green',
  },
];
...
export const pricingComparison = [
  { feature: 'Setup iniziale', starter: '1h consulenza', business: '4h + training', scale: '8h + audit + training' },
  { feature: 'Support', starter: 'Email', business: 'Priority (email + Slack)', scale: 'Dedicato (Slack 24/5 + phone)' },
  { feature: 'Training/onboarding', starter: false, business: true, scale: true },
  { feature: 'Integrazioni custom', starter: false, business: false, scale: 'Max 2' },
  { feature: 'Monthly optimization call', starter: false, business: false, scale: true },
  { feature: 'SLA garantito', starter: false, business: false, scale: true },
];

// Slug allineati a softwareFamilies, per coerenza se in futuro si vuole
// linkare ogni voce del configuratore alla pagina famiglia corrispondente.
export const configuratorSoftware = [
  { id: 'agente-commerciale', name: 'Agente Commerciale AI', price: 99 },
  { id: 'assistente-clienti-knowledge-base', name: 'Assistente Clienti', price: 69 },
  { id: 'automazione-preventivi-processi', name: 'Automazione Preventivi', price: 79 },
  { id: 'reputation-customer-follow-up', name: 'Reputation Follow-up', price: 49 },
];

export const supportTiers = [
  { id: 'basic', name: 'Basic', price: 0, description: 'Incluso nei piani' },
  { id: 'priority', name: 'Priority', price: 29, description: 'Slack + email prioritaria' },
  { id: 'dedicated', name: 'Dedicated', price: 99, description: 'Slack 24/5 + phone + weekly call' },
];

export const pricingFaqs = [
  { q: 'Posso cambiare piano dopo?', a: 'Sì, modifica o upgrade in qualsiasi momento dall’area clienti.' },
  { q: 'C’è un contratto vincolante?', a: 'No, mensile. Puoi cancellare quando vuoi (preavviso 7 giorni).' },
  { q: 'Incluso il setup iniziale?', a: 'Sì, setup e training sono inclusi nel piano. Tempo massimo 48h.' },
  { q: 'Cosa succede dopo la prova gratuita?', a: 'Ti avvisiamo per email. Se non confermi, non ti addebitiamo nulla.' },
  { q: 'Servono software custom?', a: 'Contatta Matteo per un preventivo personalizzato.' },
];
