...
export const businessSuiteModules = [
  ...
  },
  {
    ...
    pricing: {
      monthly: null,
      includedInPackages: ['crescita', 'ecosistema'],
      activation: '249€ (come primo software) o 449€',
  ...
  },
  {
    ...
    pricing: {
      ...
      activation: '699€ (o inclusa in bundle)',
...
export const businessSuitePackages = [
  {
    id: 'essenziale',
    name: 'MG Essenziale',
    benefitTitle: 'Risolvi il tuo primo problema',
    price: 89,
    tagline:
      'Per cantine, frantoi e agriturismi che vogliono iniziare semplice. Automatizza contatti, prenotazioni o email. Basta.',
    activation: 249,
    trialDays: 30,
    features: [
      '1 software a scelta',
      ...
      '1 sede',
      '2 integrazioni',
      'Assistenza email entro 2 giorni',
      'Sessione formazione iniziale (30 min)',
      'Aggiornamenti inclusi',
    ],
    examples: [
      'Esempio: una cantina piccola usa solo Lead & Sales per gestire i contatti commerciali — 89€/mese, basta.',
      'Esempio: un agriturismo usa solo Booking per le prenotazioni online — 89€/mese, semplice.',
    ],
    cta: 'Inizia adesso',
  ...
  },
  {
    id: 'crescita',
    name: 'MG Crescita',
    benefitTitle: 'Automatizza davvero il tuo business',
    price: 179,
    tagline:
      'Per aziende agroalimentari che vogliono crescere. 3 software che lavorano insieme. Il pacchetto che consigliamo di più.',
    badge: 'Più scelto dai nostri clienti',
    activation: 449,
    trialDays: 45,
    features: [
      '3 software a scelta',
      ...
      'Automazioni tra i software (il vero valore)',
      'Report centralizzato',
      'Verifica trimestrale automazioni',
      'Assistenza prioritaria (entro 1 giorno)',
      'Formazione del team (2 sessioni)',
      'Aggiornamenti inclusi',
    ],
    examples: [
      'Esempio: una cantina media usa Lead & Sales (contatti) + Booking (degustazioni) + Social AI (promozioni). Tutto automatico, tutto connesso — 179€/mese.',
      'Esempio: un frantoio usa Lead & Sales + Social AI + Control Tower. Vede chi compra cosa e quando, e decide con dati reali.',
    ],
    cta: 'Richiedi demo personalizzata',
    ctaSub: 'Parliamo della tua situazione (15 min)',
    highlight: 'blue',
  },
  {
    id: 'ecosistema',
    name: 'MG Ecosistema',
    benefitTitle: 'Scala senza limiti',
    price: 249,
    tagline:
      'Per aziende strutturate. Tutti i 5 software. Utenti illimitati, più sedi, più integrazioni. Personalizzazione completa.',
    activation: 699,
    trialDays: 60,
    features: [
      ...
      'Assistenza prioritaria + telefonica',
      'Incontro mensile di ottimizzazione',
      'Referente MG Solutions dedicato',
      'Aggiornamenti inclusi',
    ],
    examples: [
      'Esempio: una cantina che vende su più canali (online, in cantina, enoturismo, wine club) tiene tutto dentro MG Business Suite, con una dashboard unica per governare le decisioni.',
      'Esempio: una rete di più frantoi con magazzini distinti gestisce tutto in modo centralizzato — meno eccedenze, meno ordini persi, margini tracciati.',
    ],
    cta: 'Pianifica chiamata strategica',
...
export const businessSuiteComparison = [
  { feature: 'Setup iniziale (una tantum)', essenziale: '249€', crescita: '449€', ecosistema: '699€' },
  { feature: 'Software', essenziale: '1 a scelta', crescita: '3 a scelta', ecosistema: 'Tutti e 5' },
  { feature: 'Utenti', essenziale: 'Fino a 3', crescita: 'Fino a 10', ecosistema: 'Illimitati' },
  ...
  { feature: 'Prova gratuita', essenziale: '30 giorni', crescita: '45 giorni', ecosistema: '60 giorni' },
];
...
export const webBundles = [
  {
    ...
    name: 'MG Web One',
    price: 188,
    items: ['Manutenzione sito (99€)', '1 software (89€)'],
    activation: 249,
  },
  {
    id: 'web-growth',
    name: 'MG Web Growth',
    price: 278,
    items: ['Manutenzione sito (99€)', '3 software (179€)'],
    activation: 449,
  },
  {
    id: 'web-suite',
    name: 'MG Web Suite',
    price: 348,
    items: ['Manutenzione sito (99€)', 'Tutti e 5 i software (249€)'],
    activation: 699,
  },
];
...
export const businessSuiteFaqs = [
  {
    q: 'Il software è difficile da usare?',
    a: 'No. Se sai usare WhatsApp o la posta elettronica, sai usare MG Business Suite. Include una sessione di formazione iniziale (Essenziale), due sessioni per il team (Crescita) o formazione dedicata con incontri mensili (Ecosistema).',
  },
  {
    q: 'Qual è la differenza rispetto ad altri software di settore?',
    a: 'Molti software per il settore agroalimentare sono pensati solo per le cantine. MG Business Suite copre cantine, frantoi, agriturismi e aziende B2B, e si adatta al tuo settore specifico. Scegli solo i software che ti servono, non un pacchetto fisso con funzioni che non userai mai.',
  },
  {
    q: 'Come funziona se cambio idea e voglio aggiungere un software?',
    a: 'Facilissimo. Se parti con Essenziale e un software, puoi aggiungerne altri passando a Crescita quando vuoi: la transizione è automatica, senza perdita di dati.',
  },
  {
    q: 'Posso restare a budget ma cambiare quali software uso?',
    a: 'Sì. In Crescita puoi cambiare i 3 software scelti quando vuoi, restando a 179€/mese: se un tool non ti serve più, lo togli e ne attivi un altro.',
  },
  {
    q: 'È incluso il supporto per errori o problemi?',
    a: 'Sì. Essenziale: email entro 2 giorni. Crescita ed Ecosistema: assistenza prioritaria entro 1 giorno (Ecosistema anche telefonica). Se il problema dipende da un nostro bug, non paghi nulla per la correzione.',
  },
  {
    q: 'Posso provare senza impegno?',
    a: 'Sì: 30 giorni di prova con Essenziale, 45 con Crescita, 60 con Ecosistema. Se decidi di non proseguire, cancelli senza costi ricorrenti.',
  },
  {
    q: 'Posso cancellare quando voglio?',
    a: 'Il canone mensile sì, cancellabile con 7 giorni di preavviso. Il setup iniziale non è rimborsabile: è l’investimento in configurazione, non un costo ricorrente.',
  },
  {
    q: 'Quanto tempo prima di vedere i primi risultati?',
    a: 'Lead & Sales raccoglie contatti dal sito da subito. Booking è operativo appena configurato. Social AI inizia a proporre contenuti dalla prima settimana. In genere i primi risultati concreti si vedono in 2-4 settimane.',
  },
];
