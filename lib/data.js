...
export const siteDevPricing = {
  from: 2500,
  typicalRange: '3.000-5.000€',
  note: 'A seconda di quante pagine servono e se c’è la parte prenotazioni.',
};
...
export const ecommerceDevPricing = {
  from: 3500,
  typicalRange: '4.000-7.000€',
  note: 'A seconda di catalogo, integrazioni e se serve un abbonamento ricorrente.',
};
...
// Restyling: solo una tantum, nessun canone incluso.
export const restylingPricing = {
  mirato: '900€',
  completo: '2.000-3.500€',
};
...
export const servizi = [
  ...
  },
  {
    ...
    problemBlock: {
      ...
      image: '/images/servizi/ecommerce-shopify-problema.jpg',
      imageAlt: 'Bottiglie o prodotti agroalimentari pronti per la spedizione diretta al cliente',
    },
    changeBlock: {
      ...
      image: '/images/servizi/ecommerce-shopify-cambia.jpg',
      imageAlt: 'Schermata di un catalogo e-commerce con schede prodotto curate',
    },
    includes: [
    ...
    investment: {
      intro: `Gli store che facciamo partono da ${ecommerceDevPricing.from.toLocaleString('it-IT')}€ e la maggior parte sta tra ${ecommerceDevPricing.typicalRange}, a seconda di catalogo e integrazioni.`,
      careLine: `Poi c’è l’assistenza: i primi tre mesi sono inclusi, dopo potete continuare con noi da ${ecommerceWebCare.price}€/mese oppure gestirlo da soli, perché vi formiamo per essere autonomi.`,
      closing: 'La cifra esatta ve la diciamo dopo la prima call, non prima: dipende da cosa vi serve davvero.',
    },
    faqs: [
  ...
  },
  {
    ...
    problemBlock: {
      ...
      image: '/images/servizi/siti-web-contatti-problema.jpg',
      imageAlt: 'Cantina o agriturismo di sera, schermo di un telefono con una mail in bozza',
    },
    changeBlock: {
      ...
      image: '/images/servizi/siti-web-contatti-cambia.jpg',
      imageAlt: 'Calendario di prenotazioni online con date disponibili',
    },
    includes: [
    ...
    investment: {
      intro: `I siti che facciamo partono da ${siteDevPricing.from.toLocaleString('it-IT')}€ e la maggior parte sta tra ${siteDevPricing.typicalRange}, a seconda di quante pagine servono e se c’è la parte prenotazioni.`,
      careLine: `Poi c’è l’assistenza: i primi tre mesi sono inclusi, dopo potete continuare con noi da ${webCare.price}€/mese oppure gestirlo da soli, perché vi formiamo per essere autonomi.`,
      closing: 'La cifra esatta ve la diciamo dopo la prima call, non prima: dipende da cosa vi serve davvero.',
    },
    faqs: [
  ...
  },
  {
    ...
    problemBlock: {
      ...
      image: '/images/servizi/restyling-ottimizzazione-problema.jpg',
      imageAlt: 'Sito web datato aperto su un monitor, da rivedere',
    },
    changeBlock: {
      ...
      image: '/images/servizi/restyling-ottimizzazione-cambia.jpg',
      imageAlt: 'Report di audit tecnico con metriche di velocità e SEO',
    },
    includes: [
    ...
    investment: {
      intro: `Gli interventi mirati (velocità, SEO, una sezione) partono da ${restylingPricing.mirato}; un restyling completo (grafica, contenuti, struttura) sta tra ${restylingPricing.completo}.`,
      careLine: `Dopo l’intervento potete aggiungere l’assistenza continuativa da ${webCare.price}€/mese per mantenere il sito in piedi 24/7.`,
      closing: 'La cifra esatta ve la diciamo dopo aver guardato il sito, non prima.',
    },
    faqs: [
  ...
  },
  {
    ...
    problemBlock: {
      ...
      image: '/images/servizi/consulenza-strategica-problema.jpg',
      imageAlt: 'Fogli e grafici sparsi su una scrivania, numeri mai messi insieme',
    },
    changeBlock: {
      ...
      image: '/images/servizi/consulenza-strategica-cambia.jpg',
      imageAlt: 'Documento con roadmap di priorità ordinate',
    },
    includes: [
    ...
    investment: {
      intro: `${consulenzaPricing.range}, scalati dal costo del progetto se poi decidete di proseguire insieme.`,
      careLine: null,
      closing: 'La cifra esatta dipende dalla complessità del progetto: la definiamo nella prima call, gratuita e senza impegno.',
    },
    faqs: [
