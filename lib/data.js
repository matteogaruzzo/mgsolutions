...
export const businessSuitePackages = [
  {
    ...
    tagline: 'Un solo modulo attivo. Pensato per chi vuole risolvere una priorità specifica prima di allargarsi.',
    activationLabel: 'Costo di attivazione da definire',
    features: [
      '1 modulo a scelta tra quelli disponibili',
    ...
    availabilityNote:
      'Oggi il solo modulo attivabile in accesso anticipato è MG Lead & Sales. Gli altri si aggiungeranno man mano che saranno pronti.',
...
export const businessSuiteComparison = [
  { feature: 'Prezzo', essenziale: 'In definizione', crescita: 'In definizione', ecosistema: 'In definizione' },
...
export const webBundles = [
  {
    ...
    name: 'MG Web One',
    priceLabel: 'Prezzo in definizione',
    items: ['Manutenzione sito (99€/mese)', 'Piano Essenziale (1 modulo, prezzo da definire)'],
...
export const businessSuiteFaqs = [
  ...
  {
    q: 'Quanto costa?',
    a: 'Non c’è ancora un prezzo pubblico. Durante l’accesso anticipato definiamo il canone insieme a ogni azienda, in base a moduli, utenti e integrazioni necessarie. I piani Essenziale, Crescita ed Ecosistema descrivono la struttura futura, non un canone attivo.',
  },
  {
