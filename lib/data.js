...
export const businessSuiteModules = [
  {
    ...
    resultForClient: 'Contenuti proposti dall’AI, tu approvi prima che escano: presenza costante senza assumere nessuno.',
    icon: 'chat',
  ...
  },
  {
    ...
    resultForClient: 'Un unico archivio con follow-up automatici: niente contatti persi per dimenticanza.',
    icon: 'target',
  ...
  },
  {
    ...
    status: 'roadmap',
    statusLabel: 'In roadmap',
    problemSolved: 'Prenotazioni gestite solo a telefono, con calendario confuso e occasioni perse fuori orario.',
    resultForClient: 'Calendario online sempre aperto: il cliente prenota da solo, tu vedi tutto in un posto.',
    icon: 'calendar',
  ...
  },
  {
    ...
    resultForClient: 'Turni, task e checklist in un posto solo: il team sa cosa fare senza riunioni.',
    icon: 'clock',
  ...
  },
  {
    ...
    resultForClient: 'Una dashboard che aggrega gli altri moduli attivi. Nota: non è indipendente — serve almeno un altro modulo attivo da aggregare.',
    icon: 'chart',
    heroImage: '/images/software/control-tower-hero.jpg',
    tagline: 'La dashboard del direttore: tutto in un unico sguardo',
    whatItDoes: 'Dashboard direzionale che aggrega i dati degli altri moduli della suite attivi e del sito. Non è un modulo indipendente: senza almeno un altro modulo attivo non ha dati da mostrare.',
    narrative: [
      ...
      'MG Control Tower non è un modulo che funziona da solo: aggrega in un’unica dashboard i dati generati dagli altri moduli della suite già attivi (Lead & Sales, Booking, Social AI, Staff & Operations) e dal sito. Più moduli sono attivi, più insight genera; per questo è incluso solo nel piano Ecosistema, dove tutti i moduli sono presenti.',
    ...
    faqs: [
      { q: 'Control Tower funziona da solo, senza altri moduli attivi?', a: 'No. Control Tower aggrega i dati degli altri moduli della suite: senza almeno un altro modulo attivo (Lead & Sales, Booking, Social AI o Staff & Operations) non ha dati da mostrare. Per questo è incluso solo nel piano Ecosistema.' },
...
export const businessSuiteFaqs = [
  ...
  },
  {
    ...
    a: 'Crescita includerà fino a 3 moduli a scelta tra quelli disponibili. Ecosistema includerà tutti i moduli pubblicati, compreso Control Tower — che aggrega i dati degli altri moduli attivi e per questo non ha senso in un piano con solo 1-3 moduli.',
  },
  {
    q: 'Control Tower funziona da solo?',
    a: 'No. Control Tower non è un modulo indipendente: aggrega i dati generati dagli altri moduli già attivi (Lead & Sales, Booking, Social AI, Staff & Operations). Senza almeno un altro modulo attivo non ha dati da mostrare — per questo è previsto solo nel piano Ecosistema.',
  },
  {
