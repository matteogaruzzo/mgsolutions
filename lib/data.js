...
import { SOFTWARE_PLANS, SOFTWARE_PLAN_ORDER } from './config/software-plans';
...
// ---- MG BUSINESS SUITE — MODULI E PIANI --------------------------------
// Dati centralizzati in lib/config/software-modules.js e
// lib/config/software-plans.js. Non duplicare qui prezzi, limiti o
// contenuti dei moduli: importare da quei file.
export { SOFTWARE_MODULES as businessSuiteModules, getModule as getBusinessSuiteModule } from './config/software-modules';


// ---- MG BUSINESS SUITE: PIATTAFORMA MODULARE ---------------------------
export const softwareUpcoming = {
  title: 'Un solo account, moduli attivabili in base al piano',
  body:
    'I moduli di MG Business Suite non sono programmi separati: si attivano all’interno dello stesso account aziendale, in base al piano scelto. Trovi la struttura completa dei piani in /software/pricing.',
};
...
// ---- MG BUSINESS SUITE — PIANI E CONFRONTO ------------------------------
// Prezzi e limiti centralizzati in lib/config/software-plans.js. Le forme
// sotto adattano quei dati alla shape richiesta da PricingTiers e
// PricingComparison, senza duplicare i valori numerici.
export const businessSuitePackages = SOFTWARE_PLAN_ORDER.map((id) => {
  const p = SOFTWARE_PLANS[id];
  return {
    id: p.id,
    name: p.name,
    benefitTitle: p.tagline,
    price: p.monthlyPrice,
    activation: p.setupPrice,
    trialDays: p.trialDays,
    priceLabel: `€${p.monthlyPrice}/mese`,
    tagline: p.description,
    activationLabel: `€${p.setupPrice} di setup (una tantum) — ${p.setupDescription.charAt(0).toLowerCase()}${p.setupDescription.slice(1)}`,
    features: p.features,
    cta: p.cta,
    ctaHref: p.ctaHref,
    ctaSub: `Prova gratis ${p.trialDays} giorni`,
    highlight: p.highlighted ? 'green' : null,
    badge: p.badge,
  };
});
...
export const businessSuiteComparison = [
  {
    feature: 'Moduli',
    essenziale: SOFTWARE_PLANS.essenziale.moduleLimitLabel,
    crescita: SOFTWARE_PLANS.crescita.moduleLimitLabel,
    ecosistema: SOFTWARE_PLANS.ecosistema.moduleLimitLabel,
  },
  {
    feature: 'Prezzo',
    essenziale: `€${SOFTWARE_PLANS.essenziale.monthlyPrice}/mese`,
    crescita: `€${SOFTWARE_PLANS.crescita.monthlyPrice}/mese`,
    ecosistema: `€${SOFTWARE_PLANS.ecosistema.monthlyPrice}/mese`,
  },
  {
    feature: 'Setup (una tantum)',
    essenziale: `€${SOFTWARE_PLANS.essenziale.setupPrice}`,
    crescita: `€${SOFTWARE_PLANS.crescita.setupPrice}`,
    ecosistema: `€${SOFTWARE_PLANS.ecosistema.setupPrice}`,
  },
  {
    feature: 'Prova gratuita',
    essenziale: `${SOFTWARE_PLANS.essenziale.trialDays} giorni`,
    crescita: `${SOFTWARE_PLANS.crescita.trialDays} giorni`,
    ecosistema: `${SOFTWARE_PLANS.ecosistema.trialDays} giorni`,
  },
  {
    feature: 'Utenti',
    essenziale: SOFTWARE_PLANS.essenziale.userLimitLabel,
    crescita: SOFTWARE_PLANS.crescita.userLimitLabel,
    ecosistema: SOFTWARE_PLANS.ecosistema.userLimitLabel,
  },
  {
    feature: 'Sedi',
    essenziale: SOFTWARE_PLANS.essenziale.siteLimitLabel,
    crescita: SOFTWARE_PLANS.crescita.siteLimitLabel,
    ecosistema: SOFTWARE_PLANS.ecosistema.siteLimitLabel,
  },
  {
    feature: 'Integrazioni',
    essenziale: SOFTWARE_PLANS.essenziale.integrationLimitLabel,
    crescita: SOFTWARE_PLANS.crescita.integrationLimitLabel,
    ecosistema: SOFTWARE_PLANS.ecosistema.integrationLimitLabel,
  },
  {
    feature: 'Automazioni tra moduli',
    essenziale: SOFTWARE_PLANS.essenziale.automations,
    crescita: SOFTWARE_PLANS.crescita.automations,
    ecosistema: SOFTWARE_PLANS.ecosistema.automations,
  },
  {
    feature: 'Control Tower',
    essenziale: SOFTWARE_PLANS.essenziale.controlTower,
    crescita: SOFTWARE_PLANS.crescita.controlTower,
    ecosistema: SOFTWARE_PLANS.ecosistema.controlTower,
  },
  {
    feature: 'Supporto',
    essenziale: SOFTWARE_PLANS.essenziale.supportLabel,
    crescita: SOFTWARE_PLANS.crescita.supportLabel,
    ecosistema: SOFTWARE_PLANS.ecosistema.supportLabel,
  },
];
...
export const businessSuiteFaqs = [
  {
    ...
    a: 'Una piattaforma online modulare: un unico account aziendale in cui attivi i moduli che ti servono in base al piano scelto. Non sono programmi separati da installare, ma sezioni della stessa piattaforma che condividono gli stessi dati.',
  },
  {
    q: 'Quanto costa?',
    a: `MG Essenziale costa €${SOFTWARE_PLANS.essenziale.monthlyPrice}/mese + €${SOFTWARE_PLANS.essenziale.setupPrice} di setup una tantum, con ${SOFTWARE_PLANS.essenziale.trialDays} giorni di prova gratis. Crescita costa €${SOFTWARE_PLANS.crescita.monthlyPrice}/mese + €${SOFTWARE_PLANS.crescita.setupPrice} di setup, prova di ${SOFTWARE_PLANS.crescita.trialDays} giorni. Ecosistema costa €${SOFTWARE_PLANS.ecosistema.monthlyPrice}/mese + €${SOFTWARE_PLANS.ecosistema.setupPrice} di setup, prova di ${SOFTWARE_PLANS.ecosistema.trialDays} giorni.`,
  },
  {
    q: 'A cosa serve il setup una tantum?',
    a: 'Copre l’attivazione e la configurazione della piattaforma per la tua azienda: creazione dell’account, import dei contatti esistenti e formazione iniziale. Si paga una sola volta, non è ricorrente.',
  },
  {
  ...
  {
    q: 'Posso iniziare con un piano e passare a un altro dopo?',
    a: 'Sì. Puoi fare upgrade o downgrade quando vuoi: i tuoi dati restano nello stesso account.',
  },
  {
  ...
  {
    q: 'Posso scegliere liberamente quali moduli attivare?',
    a: 'Sì. Lead & Sales, Social AI, Booking & Experience e Staff & Operations sono selezionabili in tutti e tre i piani: scegli tu quali attivare, senza dover salire di piano per sbloccarli. L’unica eccezione è Control Tower, incluso solo in Ecosistema perché aggrega i dati degli altri moduli attivi e ha senso solo quando più di uno lavora insieme.',
  },
  {
    q: 'Posso cambiare i moduli attivi dopo l’attivazione?',
    a: 'Sì. Puoi attivare o disattivare i moduli inclusi nel tuo piano in qualsiasi momento, senza costi aggiuntivi per il cambio.',
  },
  {
    q: 'Che differenza c’è tra Crescita ed Ecosistema?',
    a: 'Crescita ed Ecosistema danno accesso agli stessi moduli operativi, a scelta libera. La differenza è nella capacità della piattaforma — utenti, sedi, integrazioni, supporto — e nel fatto che solo Ecosistema include anche Control Tower, la dashboard che aggrega i dati degli altri moduli attivi.',
  },
  {
    q: 'Control Tower funziona da solo?',
    a: 'No. Control Tower non è un modulo indipendente: aggrega i dati generati dagli altri moduli attivi (Lead & Sales, Booking, Social AI, Staff & Operations). Per questo è incluso solo nel piano Ecosistema.',
  },
  {
  ...
  },
  {
    ...
    a: 'No. La piattaforma è accessibile online da browser, senza installazioni. Gli aggiornamenti vengono distribuiti automaticamente.',
  },
];
...
export const posts = [
  ...
  },
  {
    ...
    title: 'Software per Cantine: Tutto Quello che Ti Serve in Una Piattaforma',
    seoTitle: 'Software per Cantine: la Piattaforma MG Business Suite',
    excerpt:
      'Un CRM, un tool per le prenotazioni, un foglio Excel per il team: più strumenti separati usi, più dati si perdono tra un sistema e l’altro. Ecco cosa cercare in una piattaforma unica per cantine, frantoi e agriturismi.',
    date: '2026-08-05',
    readingMinutes: 9,
    category: 'Agribusiness AI',
    ...
    relatedLinks: [
      { href: '/software', label: 'MG Business Suite: tutti i moduli' },
      { href: '/software/pricing', label: 'Piani e prezzi di MG Business Suite' },
      { href: '/software/lead-sales', label: 'Modulo: MG Lead & Sales (CRM)' },
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Altrettanto importante è che questi moduli comunichino tra loro: un ordine che genera automaticamente un contatto nel CRM, una prenotazione che aggiorna il calendario di tutto il team, un follow-up che parte da solo dopo una visita, senza che qualcuno debba ricordarsene manualmente.',
        ],
      },
      {
        h2: 'Come funziona una piattaforma con moduli integrati',
        paragraphs: [
          'MG Business Suite è organizzata in moduli pensati specificamente per aziende agroalimentari e hospitality, non adattati da un software generico. **MG Lead & Sales** centralizza contatti e opportunità che altrimenti restano sparsi tra email, agende e WhatsApp, distinguendo un privato che chiede una degustazione da un distributore che valuta un ordine all’ingrosso.',
          '**MG Booking & Experience** gestisce l’intera esperienza del cliente, dalla prenotazione alla recensione, con un calendario centralizzato al posto delle prenotazioni gestite solo a telefono. **MG Staff & Operations** organizza turni, task e checklist del team in un unico posto, riducendo le dimenticanze nei periodi di picco. **MG Social AI** automatizza la presenza sui social con contenuti proposti dall’AI che il team approva prima della pubblicazione.',
          '**MG Control Tower**, incluso nel piano Ecosistema, aggrega in un’unica dashboard direzionale i dati degli altri moduli attivi — utile quando le informazioni da controllare arrivano ormai da più fonti diverse.',
        ],
      },
      {
        h2: 'Un esempio dal settore',
        paragraphs: [
          ...
          'La soluzione ha automatizzato prenotazioni, schede di degustazione per il sommelier e follow-up post-visita, con un risultato di +25% nella conversione da degustazione a iscrizione al wine club e circa 15 ore al mese di lavoro amministrativo risparmiate — tempo restituito all’accoglienza in cantina invece che alla gestione dei fogli di calcolo.',
        ],
      },
      {
        h2: 'I piani di MG Business Suite e come scegliere quello giusto',
        paragraphs: [
          'MG Business Suite è organizzata in tre piani, pensati per fasi diverse di crescita. Il piano **Essenziale** (89€/mese più 249€ di attivazione una tantum, 30 giorni di prova) è pensato per chi vuole risolvere un processo prioritario: fino a 3 utenti, 1 sede, 2 integrazioni.',
          'Il piano **Crescita** (179€/mese più 449€ di attivazione, 45 giorni di prova) aggiunge automazioni tra i moduli attivi ed è pensato per aziende che gestiscono più aree contemporaneamente: fino a 10 utenti, 2 sedi, 6 integrazioni — è il piano scelto dalla maggior parte delle aziende che passano da strumenti sparsi a una piattaforma unica.',
          'Il piano **Ecosistema** (249€/mese più 699€ di attivazione, 60 giorni di prova) include anche MG Control Tower, utenti illimitati e fino a 5 sedi: ha senso per aziende strutturate o reti di aziende che hanno bisogno di una vista direzionale su tutto.',
        ],
      },
      {
        h2: 'Domande frequenti sul software per cantine',
        paragraphs: [
          '**Quanto tempo serve per passare da un altro software?** Dipende da quanti dati vanno migrati, ma l’attivazione della piattaforma richiede in genere pochi giorni, non i mesi tipici di un ERP enterprise.',
          '**Se cambio idea dopo qualche mese, i miei dati restano bloccati?** No: i dati inseriti restano tuoi e possono essere esportati.',
          '**Serve attivare un modulo per ogni area fin da subito?** No, si può iniziare da un solo modulo — tipicamente CRM o prenotazioni, a seconda di dove si perde più tempo oggi — e aggiungerne altri in un secondo momento.',
          '**Quale piano è adatto a una piccola cantina con pochi dipendenti?** Nella maggior parte dei casi il piano Essenziale è sufficiente per iniziare; si passa al piano Crescita quando servono automazioni tra più moduli attivi contemporaneamente.',
        ],
      },
      {
        h2: 'Da dove iniziare',
        paragraphs: [
          ...
          'MG Business Suite nasce per aziende agroalimentari e hospitality che vogliono smettere di gestire il lavoro tra strumenti sparsi. [Scopri i moduli e i piani →](/software)',
        ],
      },
    ],
  },
  {
    ...
    relatedLinks: [
      { href: '/servizi/siti-web-contatti', label: 'Servizio: Siti web che generano contatti' },
      { href: '/settori/wine-hospitality-agriturismi', label: 'Settore Wine Hospitality & Agriturismi' },
      { href: '/software/booking-experience', label: 'Software: Booking & Experience' },
  ...
  },
  {
    ...
    title: 'Software per Agriturismi: Prenotazioni, CRM e Team in Una Piattaforma',
    seoTitle: 'Software per Agriturismi: la Piattaforma MG Business Suite',
    excerpt:
      'Un software di sole prenotazioni non basta se poi CRM, team ed email restano su strumenti separati. Ecco cosa cercare in una piattaforma pensata per chi vende esperienze, non solo camere.',
    date: '2026-08-05',
    readingMinutes: 9,
    category: 'Agribusiness AI',
    ...
    relatedLinks: [
      { href: '/software', label: 'MG Business Suite: tutti i moduli' },
      { href: '/software/booking-experience', label: 'Modulo: MG Booking & Experience' },
      { href: '/software/staff-operations', label: 'Modulo: MG Staff & Operations' },
      { href: '/portfolio/podere-la-vite', label: 'Case study concept: Podere La Vite' },
    ],
    body: [
      {
      ...
      },
      {
        h2: 'Come funziona una piattaforma con moduli integrati',
        paragraphs: [
          '**MG Booking & Experience** gestisce l’intera esperienza del cliente, dalla prenotazione alla recensione, con un calendario centralizzato al posto delle prenotazioni gestite solo a telefono — ed è qui che si propongono le esperienze insieme al soggiorno.',
          '**MG Lead & Sales** centralizza i contatti degli ospiti, distinguendo chi prenota per la prima volta da chi torna, con follow-up che partono da soli invece di dover essere ricordati. **MG Staff & Operations** organizza turni, task e checklist del team in un unico posto — utile soprattutto nei periodi di alta stagione, quando le dimenticanze costano di più.',
          '**MG Social AI** automatizza la presenza social con contenuti proposti dall’AI che il team approva prima della pubblicazione. **MG Control Tower**, incluso nel piano Ecosistema, aggrega in un’unica dashboard i dati degli altri moduli attivi.',
        ],
      },
      {
        h2: 'Un esempio dal settore',
      ...
      {
        h2: 'I piani di MG Business Suite per agriturismi',
        paragraphs: [
          'Il piano **Essenziale** (89€/mese più 249€ di attivazione, 30 giorni di prova) è pensato per un agriturismo con poche camere che vuole risolvere prima di tutto le prenotazioni: fino a 3 utenti, 1 sede, 2 integrazioni.',
          'Il piano **Crescita** (179€/mese più 449€ di attivazione, 45 giorni di prova) è pensato per agriturismi con prenotazioni più strutturate che vogliono collegare booking, CRM e team: fino a 10 utenti, 2 sedi, 6 integrazioni, con automazioni tra i moduli attivi.',
          'Il piano **Ecosistema** (249€/mese più 699€ di attivazione, 60 giorni di prova) aggiunge MG Control Tower e ha senso per strutture più grandi o multi-location, con utenti illimitati e fino a 5 sedi.',
        ],
      },
      {
        h2: 'Domande frequenti sul software per agriturismi',
        paragraphs: [
          '**Posso continuare a usare Booking.com e Airbnb insieme alla piattaforma?** Sì, la sincronizzazione con i principali canali evita l’overbooking mentre il canale diretto cresce.',
          '**Quanto tempo serve per passare da un altro software?** Dipende da quanti dati vanno migrati, ma l’attivazione richiede in genere pochi giorni, non i mesi tipici di un ERP enterprise.',
          '**Ha senso anche per un B&B con poche camere?** Sì: il piano Essenziale è pensato proprio per strutture piccole che vogliono partire da un solo processo prioritario, tipicamente le prenotazioni.',
          '**Serve formazione per il team?** Sì, viene inclusa all’attivazione; l’interfaccia è pensata per essere usata senza competenze tecniche.',
        ],
      },
      {
        h2: 'Da dove iniziare',
        paragraphs: [
          ...
          'MG Business Suite nasce per agriturismi, cantine e frantoi che vogliono smettere di gestire il lavoro tra strumenti sparsi. [Scopri i moduli e i piani →](/software)',
        ],
      },
    ],
  },
  {
    ...
    relatedLinks: [
      { href: '/servizi/ecommerce-shopify', label: 'Servizio: E-commerce Shopify performanti' },
      { href: '/settori/oleifici-food-tech', label: 'Settore Oleifici & Food Tech' },
      { href: '/software/lead-sales', label: 'Software: MG Lead & Sales (CRM)' },
