...
export const businessSuiteModules = [
  {
    ...
    keyFlow: {
      steps: ['L’AI crea', 'Il cliente approva', 'Il software pubblica'],
      note: 'Nessun contenuto esce senza il tuo via libera: quello che ci differenzia da chi pubblica senza controllo.',
    },
    benefits: [
  ...
  },
  {
    ...
    keyFlow: {
      steps: ['Contatto raccolto', 'Segmentato automaticamente', 'Seguito fino alla vendita'],
      note: 'Per una cantina, distingue da solo clienti privati, ristoranti, distributori, importatori, richieste di degustazione e richieste e-commerce. Non è HubSpot generico: è costruito sulle necessità vere dell’agroalimentare.',
    },
    benefits: [
  ...
  },
  {
    ...
    keyFlow: {
      steps: [
        'Prenotazione degustazione',
        'Pagamento caparra',
        'Promemoria 24h prima',
        'Proposta upgrade',
        'Email di ringraziamento',
        'Richiesta recensione',
        'Follow-up 1 settimana dopo',
      ],
      note: 'Questo aumenta notevolmente il valore medio della visita.',
    },
    benefits: [
    ...
    pricing: {
      monthly: null,
      includedInPackages: ['crescita', 'ecosistema'],
      activation: '900€ (come primo modulo) o 1.800€',
  ...
  },
  {
    ...
    whatItDoes: 'Dashboard direzionale che raccoglie dati da tutti gli altri moduli e dal sito.',
    features: [
    ...
    keyFlow: {
      steps: null,
      note:
        'Esempio di report AI: "Questa settimana le visite al sito sono aumentate del 18%, ma le prenotazioni sono diminuite del 5%. La pagina degustazioni registra molte uscite (bounce rate 65%): si consiglia di semplificare il form di prenotazione."',
    },
    benefits: [
...
export const softwareUpcoming = {
  title: 'I moduli della Business Suite sono già attivabili',
  body:
    'I 5 moduli di MG Business Suite sono pacchetti pronti, con canone e attivazione definiti: li trovi tutti in /software/pricing. Per un processo che va oltre i moduli standard, restiamo disponibili per un’estensione su misura.',
};
...
export const businessSuiteComparison = [
  ...
  { feature: 'Moduli', essenziale: '1 a scelta', crescita: '3 a scelta', ecosistema: 'Tutti e 5' },
...
export const webBundles = [
  {
    ...
    name: 'MG Web One',
    price: 269,
    items: ['Manutenzione sito (99€)', '1 modulo software (199€)'],
    activation: 900,
  },
  {
    id: 'web-growth',
    name: 'MG Web Growth',
    price: 499,
    items: ['Manutenzione sito (99€)', '3 moduli software (449€)'],
    activation: 1800,
  },
  {
    id: 'web-suite',
    name: 'MG Web Suite',
    price: 679,
    items: ['Manutenzione sito (99€)', 'Tutti e 5 i moduli (649€)'],
    activation: 2700,
  },
];
...
export const businessSuiteFaqs = [
  {
    q: 'Posso iniziare con un modulo e aggiungere altri dopo?',
    a: 'Esattamente. Inizia con quello che serve subito, aggiungi il resto quando sei pronto. L’attivazione è una tantum per nuovi moduli.',
  },
  {
