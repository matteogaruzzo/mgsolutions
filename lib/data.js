...
// Le cifre vivono in lib/pricing-data.js (unica fonte). Qui si importano
// e si aggiunge solo il copy (descrizioni, benefit, esclusioni) — niente
...
// Prezzo di "Prima automazione" e "CRM su misura": lib/pricing-data.js
// (pricing.primaAutomazione, pricing.crm).
...
export const posts = [
  ...
  },
  {
    ...
    relatedLinks: [
      { href: '/servizi/seo-geo-strategy', label: 'Servizio: SEO & GEO Strategy' },
  ...
  },
  {
    ...
    relatedLinks: [
      { href: '/servizi/automazioni-ai', label: 'Servizio: Automazioni e AI' },
      { href: '/servizi/automazioni-ai', label: 'Servizio: Integrazioni AI' },
